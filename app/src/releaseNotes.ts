...
export const LATEST_NOTE = 'בדף ניהול והנפקת פריט נוסף כפתור "בתמורה" — כשהפריט מסומן הכפתור סגול (כצבע התגית), אחרת לבן. לחיצה מחליפה את הסימון. זמין למחסנאי/מנהל.'
