...
export const LATEST_NOTE = 'כפתור מחיקת פריט עבר לאייקון פח אדום בפינה השמאלית-עליונה של שם הפריט (במקום קארד נפרד). לחיצה פותחת דיאלוג אישור עם הודעה שהפעולה אינה הפיכה.'
