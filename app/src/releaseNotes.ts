...
export const LATEST_NOTE = 'בספר רק״ם/כלי הכפתור "טנקים" נבחר כברירת מחדל בכניסה לדף. לסגירה — לחיצה חוזרת על הכפתור הפעיל (נשמר ב-URL כדי שניווט חזור-קדימה ישחזר את המצב).'
